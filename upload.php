...
<?php
// result
if(file_exists("/var/www/html/maize/job/".$ID."/".$ID."_upload.json")){
  echo "<head>";
  echo "<meta http-equiv='refresh' content='0; url=result.php?ID=".$ID."'>";
  echo "</head>";
  $stop = 1;
}else{
  $stop = 0;
  ...
  echo "<h3 style='color:#964B29'><b>Your Sequence has been uploaded Successfully!</b></h3>";
  echo "<h3 style='color:#964B29'><b>Data Processing.... (Estimated Running Time Within 30 Seconds)</b></h3>";
